...
| ----------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Schema (Structural) Validation**     | Completeness, Validity, Uniqueness, Integrity | Enforces structure and formatting rules using:<br>• **Data Type Conformance  (Validity)** — Match types (e.g., int, string, timestamp)<br>• **Null Checks (Completeness)** — Required fields must not be null<br>• **Uniqueness / PK Checks(Uniqueness/Duplicates)** — Prevent duplicate key entries<br>• **Referential Integrity(Integrity)** — Validate FK relationships (e.g., `customer_id` exists)<br>• **Format Validation(Validity)** — Check specific patterns:<br> – Dates (`YYYY-MM-DD`, ISO 8601)<br> – Currency (`$99.99`, `€1.000,00`)<br> – Time zones (`+05:30`, `UTC`)<br>🛠️ RDBMS supports these natively; for data lakes or NoSQL, use ETL/dbt/GE/Deequ. |
